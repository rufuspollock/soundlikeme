...
- IP (copyright, patents) is routinely equated with real property
- Equation is wrong, and the error causes serious misunderstanding of IP's effects
- Copyright and patents confer monopolies; real property ownership does not

## Supporting material

Rival vs non-rival goods

- Apple, car, acre of land: usable by one person at a time — economists call these rival goods
- Exclusive rights over rival goods do no harm; trade allocates to whoever values it most
- Caveat: crude first approximation; complementarities and transaction costs complicate it
- Copyright covers not one copy of a text but every copy — sole supplier of that good
- That is the definition of monopoly

Consequences

- Standard monopoly consequences: prices above the efficient level, access below it
- Efficient price = cost of reproduction; gap is deadweight loss
- Worse where reuse is extensive (new work builds on old): inhibits both access and new creation
- Analogy available: control of one apple vs control of all apples

The trade-off

- Monopoly status does not make copyright bad per se
...
- Rights-holders argue close substitutes mean copyright is not a monopoly
